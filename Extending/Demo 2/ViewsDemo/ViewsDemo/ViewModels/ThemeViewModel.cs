        ...
        public void UpdateStatusBarColor()
        {
            try
            {
                if (Device.RuntimePlatform == Device.Android)
                {
                    ...
                    var logoName = Application.Current.RequestedTheme == OSAppTheme.Dark ? "xf_dark.xml" : "xf_light.xml";
                    App.Current.Resources["logoImage"] = logoName;
                }
                else
                    App.Current.Resources["logoImage"] = "xf";
            }
            catch (Exception)
            {
