    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            MessagingCenter.Subscribe<LeadersViewModel, string>(this, MessageConsts.RequestMeeting, async (sender, LeaderId) =>
            {
                ...
                ServiceProvider.GetService<IToastMessage>()?.OpenToast(string.Format(AppResources.MeetingSubmittedFor, leader.Name));

                //DependencyService.Get<IToastMessage>()?.OpenToast(string.Format(AppResources.MeetingSubmittedFor, leader.Name));
